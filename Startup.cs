...
namespace Hospital_Management
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<HospitalDbContext>(opt => opt.UseSqlServer(this.Configuration.GetConnectionString("Con")));
            ...
            services.AddCors(options =>
            {
                options.AddDefaultPolicy(
                    builder =>
                    {
                        builder.WithOrigins("http://localhost:29498", "http://localhost:4200")
                                            .AllowAnyHeader()
                                            .AllowAnyOrigin()
                                            .AllowAnyMethod();
                    });
